<!-- PGK_GENERATED: task-index -->
# Task index

The index is generated from records.

- [TASK-000](TASK-000-bootstrap.md) — verified
- [TASK-001](TASK-001-add-cli-usage-documentation.md) — verified
- [TASK-002](TASK-002-add-chinese-requirements-document.md) — verified
